...
pub struct R(crate::R<INTRPTSET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTRPTSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTRPTSET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTRPTSET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INTRPTSET` writer"]
pub struct W(crate::W<INTRPTSET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTRPTSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INTRPTSET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTRPTSET_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CLKGEN Interrupt Register: Set\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intrptset](index.html) module"]
pub struct INTRPTSET_SPEC;
impl crate::RegisterSpec for INTRPTSET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [intrptset::R](R) reader structure"]
impl crate::Readable for INTRPTSET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [intrptset::W](W) writer structure"]
impl crate::Writable for INTRPTSET_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets INTRPTSET to value 0"]
impl crate::Resettable for INTRPTSET_SPEC {
    #[inline(always)]
