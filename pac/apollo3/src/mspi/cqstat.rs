...
pub struct CQCPL_R(crate::FieldReader<bool, bool>);
impl CQCPL_R {
    pub(crate) fn new(bits: bool) -> Self {
        CQCPL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CQCPL_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn cqpaused(&self) -> CQPAUSED_R {
        CQPAUSED_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    ...
    pub fn cqcpl(&self) -> CQCPL_R {
        CQCPL_R::new(((self.bits >> 1) & 0x01) != 0)
    }
