...
pub struct RXTHRESH_R(crate::FieldReader<u8, u8>);
impl RXTHRESH_R {
    pub(crate) fn new(bits: u8) -> Self {
        RXTHRESH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RXTHRESH_R {
...
pub struct TXTHRESH_R(crate::FieldReader<u8, u8>);
impl TXTHRESH_R {
    pub(crate) fn new(bits: u8) -> Self {
        TXTHRESH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TXTHRESH_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
