...
pub struct R(crate::R<SYSFAULTADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SYSFAULTADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SYSFAULTADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SYSFAULTADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SYSFAULTADDR` writer"]
pub struct W(crate::W<SYSFAULTADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SYSFAULTADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SYSFAULTADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SYSFAULTADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct SYSFAULTADDR_R(crate::FieldReader<u32, u32>);
impl SYSFAULTADDR_R {
    pub(crate) fn new(bits: u32) -> Self {
        SYSFAULTADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SYSFAULTADDR_R {
...
pub struct SYSFAULTADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> SYSFAULTADDR_W<'a> {
...
impl R {
    ...
    pub fn sysfaultaddr(&self) -> SYSFAULTADDR_R {
        SYSFAULTADDR_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - SYS bus address observed when a Bus Fault occurred. Once an address is captured in this field, it is held until the corresponding Fault Observed bit is cleared in the FAULTSTATUS register."]
    #[inline(always)]
    pub fn sysfaultaddr(&mut self) -> SYSFAULTADDR_W {
        SYSFAULTADDR_W { w: self }
    }
