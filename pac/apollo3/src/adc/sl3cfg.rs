...
pub struct ADSEL3_R(crate::FieldReader<u8, ADSEL3_A>);
impl ADSEL3_R {
    pub(crate) fn new(bits: u8) -> Self {
        ADSEL3_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for ADSEL3_R {
    type Target = crate::FieldReader<u8, ADSEL3_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PRMODE3_R(crate::FieldReader<u8, PRMODE3_A>);
impl PRMODE3_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRMODE3_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PRMODE3_R {
    type Target = crate::FieldReader<u8, PRMODE3_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CHSEL3_R(crate::FieldReader<u8, CHSEL3_A>);
impl CHSEL3_R {
    pub(crate) fn new(bits: u8) -> Self {
...
impl core::ops::Deref for CHSEL3_R {
    type Target = crate::FieldReader<u8, CHSEL3_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct WCEN3_R(crate::FieldReader<bool, WCEN3_A>);
impl WCEN3_R {
    pub(crate) fn new(bits: bool) -> Self {
        WCEN3_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for WCEN3_R {
    type Target = crate::FieldReader<bool, WCEN3_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct SLEN3_R(crate::FieldReader<bool, SLEN3_A>);
impl SLEN3_R {
    pub(crate) fn new(bits: bool) -> Self {
        SLEN3_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for SLEN3_R {
    type Target = crate::FieldReader<bool, SLEN3_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
