...
pub struct ADSEL5_R(crate::FieldReader<u8, ADSEL5_A>);
impl ADSEL5_R {
    pub(crate) fn new(bits: u8) -> Self {
        ADSEL5_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for ADSEL5_R {
    type Target = crate::FieldReader<u8, ADSEL5_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PRMODE5_R(crate::FieldReader<u8, PRMODE5_A>);
impl PRMODE5_R {
    pub(crate) fn new(bits: u8) -> Self {
        PRMODE5_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PRMODE5_R {
    type Target = crate::FieldReader<u8, PRMODE5_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CHSEL5_R(crate::FieldReader<u8, CHSEL5_A>);
impl CHSEL5_R {
    pub(crate) fn new(bits: u8) -> Self {
...
impl core::ops::Deref for CHSEL5_R {
    type Target = crate::FieldReader<u8, CHSEL5_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct WCEN5_R(crate::FieldReader<bool, WCEN5_A>);
impl WCEN5_R {
    pub(crate) fn new(bits: bool) -> Self {
        WCEN5_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for WCEN5_R {
    type Target = crate::FieldReader<bool, WCEN5_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct SLEN5_R(crate::FieldReader<bool, SLEN5_A>);
impl SLEN5_R {
    pub(crate) fn new(bits: bool) -> Self {
        SLEN5_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for SLEN5_R {
    type Target = crate::FieldReader<bool, SLEN5_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
