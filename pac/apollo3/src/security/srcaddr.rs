...
pub struct R(crate::R<SRCADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SRCADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SRCADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SRCADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SRCADDR` writer"]
pub struct W(crate::W<SRCADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SRCADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SRCADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SRCADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Source Addresss\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [srcaddr](index.html) module"]
